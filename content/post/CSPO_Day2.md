...
但至少現在看到這個頁面的呈現, 也代表我自己堅持了 **目標(Gaol)**
...
* **No** is the most important word for **PO** 
    * 這裡說的 **No** 當然不是要 **PO** 跟 **Team** 說 **No**
    * 這裡說的 **No** 是要 **PO** 有勇氣跟 **不那麼重要的工作** 說 **No** 
    * 因為這不是一件簡單的事, 所以這件事會是 **PO** 跟 **Team** 一起協作
...
* **Backlog Grooming**
    ...
    * 這個會議的重點, 就我自己來看
        ...
        * 是讓 **PO** 跟 **Team** 一起對於 **目標** 的多方發想與聚焦收斂
        * 這個會議 PO 可以使用的技巧主要有 2 個
        * **Impact Mapping** 跟 **User Story Mapping**
        * 主要確保 **PO** 跟 **Team** 的目標是一致的
        * 唯有目標一致, 後續才能在目標一致的前提下專注於細項工作

> 參考：[Product backlog refinement 的必要性](https://school.soft-arch.net/blog/1144911/why-pbr)
...
> ### Burnup
![Burnup](https://i.imgur.com/xE0US18.png)

> ### Burndown
![Burndown](https://i.imgur.com/HOV6EG5.jpg)

> 其實不管 **Burnup** 或是 **Burndown**

> 都是基於 **經驗法則** 來因應被問時程或是範圍上的 **可完成度** 時

> 能夠大略給出來的一個 **初步預估** 與 **雙方協調**
...
參考文章：
    1. [Impact Mapping](https://ruddyblog.wordpress.com/tag/user-story-mapping/)
    2. [User Story Mapping](https://ruddyblog.wordpress.com/tag/impact-mapping/)
...
> 利用 **User Story Split** 細探 Story 的 **細節** 並 **拆分** Story
...
> Timebox 限制, Sprint 衝刺目標 **完成 Task** 跟 **交付 Story** 甚至是 **Value**
